...
// Dynamische Basis-URL bestimmen:
let baseUrl = "http://careconnect-api"; // Standardmäßig: AKS interne Container-Kommunikation

if (isBrowser) {
  if (window.location.hostname !== "localhost") {
    // Produktiv im Browser (nicht lokal)
    baseUrl = "https://careconnect.laendletech.at/api";
  } else {
    // Lokale Entwicklung (z.B. localhost)
