...
export const loginUser = async (email, password) => {
  ...
  const response = await apiCall("/auth/login", options)
...
export const logoutUser = async () => {
  try {
    ...
    await apiCall("/auth/logout", options)
...
export const fetchUserData = async () => {
  ...
  return await apiCall("/users/me", options)
}
...
// Add a function to get user-specific medications
export const fetchUserMedications = async () => {
  const options = {
    method: "GET",
  }
  return await apiCall("/users/me/medications", options)
}
