...
export const fetchUserMedications = async () => {
  await delay(500)
  // In a real app, this would fetch medications for the current user
  return mockMedications.filter((med) => med.patientId === 101)
}

export const createMedication = async (medicationData) => {
  await delay(500)
  // In a real app, this would create a new medication
  return { id: Math.floor(Math.random() * 1000), ...medicationData }
}

export const updateMedication = async (id, medicationData) => {
  await delay(500)
  // In a real app, this would update the medication
  return { id, ...medicationData }
}

export const deleteMedication = async (id) => {
  await delay(500)
  // In a real app, this would delete the medication
  return { success: true }
}
